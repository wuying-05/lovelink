...
export default {
  data() {
    return {
      ...
      checkList: ['市级'],
      areaList: [],
      upURL: 'https://lovelink.net.cn/v1/admin/wxcustomerservice_rqcode_manager/upload',
      modifyCity: '',
      areaDefault: '',
      flag: true,
      cascaderOpen: true,
  ...
  methods: {
    verification(){
      ...
      this.$refs.from.validate(valid =>{
          if(!valid) return
          this.loading = true
          this.$request.post('v1/admin/wxcustomerservice_rqcode_manager/add',this.dataForm)
          .then(res=>{
            this.loading = false
            if(res.data.status){
